            ...
            dispatch {
                ...
                command("start") {
                    ...
                    val result = bot.sendMessage(
                        ...
                        text = "Gabacho asqueroso, iniciado"
                    )
                ...
                command("bonjour") {
                    ...
                    val result = bot.sendMessage(
                        chatId = ChatId.fromId(update.message!!.chat.id),
                        text = "No me dirijas la palabra, ser inferior"
                    )
                ...
                command("adieu") {
                    ...
                    val result =
                        bot.sendMessage(chatId = ChatId.fromId(message.chat.id), text = "Por fin, un francés menos")
